# AGENTS.md — Plateforme COMILOG × ANPI Local Connect

> Instructions de travail pour Codex sur ce projet.
> **Ces consignes complètent le AGENTS.md global de l'utilisateur** (Git Flow, conventions de commit, audit). En cas de conflit, le global prime sauf override explicite ici.
...
- **Documentation projet (docs/, README, ce AGENTS.md)** : français
...
Suit les règles du **AGENTS.md global** :
